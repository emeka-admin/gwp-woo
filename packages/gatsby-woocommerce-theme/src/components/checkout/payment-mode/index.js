	...
	return (
		<div className="mt-3">
			...
			{/* <div className="form-check woo-next-payment-input-container mt-2 stripe">
				<label className="form-check-label">
					<input defaultChecked={true} onChange={ handleOnChange } value="stripe" className="form-check-input" name="paymentMethod" type="radio"/>
					<span className="woo-next-payment-content">Stripe</span>
				</label>
			</div> */}
			<div className="stripe-fill stripe">
